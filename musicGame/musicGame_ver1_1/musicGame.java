		...
		j1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(ans.equals("에스지워너비 timeless")) {
					...
					System.out.println();
					System.out.println("힌트☆");
					System.out.println("ㅇㅅㅈㅇㄴㅂ ㅌㅇㄹㅅ(영어)");
					System.out.println();
					System.out.println("정답 >> ");
					ans = a3.nextLine();
					if(ans.equals("에스지워너비 timeless")) {
				...
				if(ans.equals("트와이스 heartshaker")) {
					...
					System.out.println();
					System.out.println("힌트☆");
					System.out.println("ㅌㅇㅇㅅ ㅎㅌㅅㅇㅋ(영어)");
					System.out.println();
					System.out.println("정답 >> ");
					ans = a8.nextLine();
					if(ans.equals("트와이스 heartshaker")) {
				...
				if(ans.equals("임창정 하루도그대를사랑하지않은적이없었다")) {
					...
					System.out.println();
					System.out.println("힌트☆");
					System.out.println("ㅇㅊㅈ ㅎㄹㄷㄱㄷㄹㅅㄹㅎㅈㅇㅇㅈㅇㅇㅇㅇ");
					System.out.println();
					System.out.println("정답 >> ");
					ans = a10.nextLine();
					if(ans.equals("임창정 하루도그대를사랑하지않은적이없었다")) {
